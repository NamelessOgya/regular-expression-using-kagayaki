...
| パターン構造 | NFA 状態数 | LPC=1 (GPU Line) (ms) | LPC=8 (Chunked-Static) (ms) | Speedup Ratio (LPC1/LPC8) | 勝者 |
|---|---|---|---|---|---|
| `zx01` (単一) | 5 | 238.74 | **236.84** | 1.01x | ほぼ同等 |
| `zx01 or zx02` (2分岐) | 10 | **39.60** | 50.52 | 0.78x | LPC=1 優位 ⚡ |
| `zx01 .. zx04` (4分岐) | 20 | **60.18** | 66.39 | 0.91x | LPC=1 優位 ⚡ |
| `zx01 .. zx08` (8分岐) | 40 | 97.81 | **93.90** | **1.04x** | **LPC=8 逆転** ✅ |
| `zx01 .. zx16` (16分岐) | 80 | 206.81 | **165.49** | **1.25x** | **LPC=8 大勝** ✅ |
| `zx01 .. zx32` (32分岐) | 160 | 507.99 | **390.81** | **1.30x** | **LPC=8 圧勝 (1.30倍速)** ✅ |
| `zx01 .. zx64` (64分岐) | 320 | 891.31 | **886.78** | 1.01x | 飽和 (L1 Spill) |
